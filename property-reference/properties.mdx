---
title: 'Molecule Design Properties'
...
| Property | Description | Range | Typical Values |
|----------|-------------|--------|----------------|
| QED | Quantitative Estimation of Drug-likeness | 0-1 | >0.6 considered drug-like |
| MolLogP | Wildman-Crippen LogP| No fixed range | 0-5 for most drugs |
| TPSA | Topological Polar Surface Area | ≥0 Å² | 20-140 Å² for oral drugs |
| ExactMolWt | Exact molecular weight | >0 g/mol | 160-500 g/mol for most drugs |
