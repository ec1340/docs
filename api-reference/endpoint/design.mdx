...
field | description
--- | ---
smiles | The SMILES representation of the molecule to be designed
target_props | The properties to optimize for (one or more of `MolLogP`, `TPSA`, `ExactMolWt`, `qed`)
target_changes | The number of changes to make to the molecule (`[1]` = increase, `[-1]` = decrease)
